<template>
        ...
        <el-popover placement="left" :width="100" v-model:visible="columnVisible">
          <template #reference>
            <el-button type="primary" @click="columnVisible = true"><el-icon><setting /></el-icon>&nbsp;展示列</el-button>
              ...
              <el-checkbox v-model="showColumn.name" disabled>环境名称</el-checkbox>
  ...
  <EnvEdit v-model:visible="editDialogVisible" :row="row"></EnvEdit>
  <EnvCreate v-model:visible="createDialogVisible"></EnvCreate>
